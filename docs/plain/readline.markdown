...
Note that once you've invoked this module, your JXcore program will not
...
program to gracefully exit:
    ...
    rl.question("What do you think of JXcore? ", function(answer) {
...
Sets the prompt, for example when you run `jx` on the command line, you see
`> `, which is JXcore's prompt.
