...
Otherwise you can use [jxcore.env.setThreadCount()]() method. See also [How to run multithreaded code?](http://jxcore.com/multithreaded-javascript-tasks/#cat-69) for more information.
