...
{
  // MozJS Gecko340 processes the compilation but fails to compile/report ? 
  // TODO (obastemur) check this on later versions / report to upstream
  assert.ok(error.message.indexOf('Uncaught exception') >= 0);
}
