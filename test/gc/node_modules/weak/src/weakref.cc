...
void Initialize(Handle<Object> target) {
  ...
  JS_METHOD_SET(target, "get", Get);
  JS_METHOD_SET(target, "create", Create);
  JS_METHOD_SET(target, "isWeakRef", IsWeakRef);
  JS_METHOD_SET(target, "isNearDeath", IsNearDeath);
  JS_METHOD_SET(target, "isDead", IsDead);
  JS_METHOD_SET(target, "callbacks", Callbacks);
  JS_METHOD_SET(target, "addCallback", AddCallback);
