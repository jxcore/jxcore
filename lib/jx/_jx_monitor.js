...
var subscribe = function(cb) {
  ...
  var json = {
    ...
    IsEmbedded: process.IsEmbedded
  };
  var env = {
    cb: cb,
    errMsg: "Cannot subscribe process " + process.pid + " to the monitor.",
    okMsg: "Process successfully subscribed process " + process.pid
            + " to the monitor."
  };
...
var unsubscribe = function(cb) {
  ...
  var env = {
    ...
    okMsg: "Process successfully unsubscribed process " + process.pid
            + " from the monitor."
  };
...
var killPath = function(_path, cb) {
  ...
  var env = {
    ...
    okMsg: "Process successfully killed process " + _path + "."
  };
    ...
    if (req_data) {
      ...
      req.on('end', function() {
        ...
        try {
          ...
          var args = parseArgs(json.argv, true, json.IsEmbedded);
