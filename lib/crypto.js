...
function Credentials(secureProtocol, flags, context) {
  if (!(this instanceof Credentials)) { return new Credentials(secureProtocol,
          flags, context); }
...
var crypto_extensions = process.binding("crypto_extension_wrap");

exports.pkcs12 = {
  extractPublicKey: crypto_extensions.extractPublicKey,
  createBundle: crypto_extensions.createBundle
};

exports.generateHKDF = crypto_extensions.generateHKDF;
