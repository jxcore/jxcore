...
(function(root) {
  ...
  freeDefine = typeof define == 'function' && typeof define.amd == 'object'
      && define.amd && define, freeExports = typeof exports == 'object'
      && exports, freeModule = typeof module == 'object' && module, freeRequire = typeof require == 'function'
      && require,
   ...
   * @name encode
   * @param {Array}
   *          codePoints The array of decimal code points.
   ...
   * @private
   * @param {Number}
   *          codePoint The numeric value of a basic code point.
   ...
   * @memberOf punycode
   * @param {String}
   *          input The Punycode string of ASCII code points.
   * @returns {String} The resulting string of Unicode code points.
   */
  function decode(input) {
    // Don't use UCS-2
    var output = [], inputLength = input.length, out, i = 0, n = initialN, bias = initialBias, basic, j, index, oldi, w, k, digit, t, length,
   ...
   * @memberOf punycode
   * @param {String}
   *          input The string of Unicode code points.
      ...
      for (j = 0; j < inputLength; ++j) {
        ...
        if (currentValue == n) {
          ...
          for (q = delta, k = base; /* no condition */; k += base) {
            ...
            qMinusT = q - t;
            baseMinusT = base - t;
            output.push(stringFromCharCode(digitToBasic(t + qMinusT
                % baseMinusT, 0)));
  ...
  function toUnicode(domain) {
    return mapDomain(domain, function(string) {
      return regexPunycode.test(string) ? decode(string.slice(4).toLowerCase())
          : string;
    });
  }
