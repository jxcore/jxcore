...
streams. JXcore has several strategies for manipulating, creating, and
...
* `'binary'` - A way of encoding raw binary data into strings by using only
  ...
  will be removed in future versions of JXcore.
...
small blocks of memory in the lifetime of a server, JXcore allocates memory
...
then JXcore will allocate a SlowBuffer slab for it directly.
