...
If no 'ca' details are given, then JXcore will use the default
...
The Crypto module was added to JXcore before there was the concept of a
unified Stream API, and before there were Buffer objects for handling
binary data.

As such, the streaming classes don't have the typical methods found on
other JXcore classes, and many methods accepted and returned
