...
By executing `jx` without any arguments from the command-line you will be
...
For advanced line-editors, start JXcore with the environmental variable
...
Multiple REPLs may be started against the same running instance of JXcore.  Each
