...
const Register ABIArgGenerator::NonArgReturnReg0 = { (Registers::Code)0 };
const Register ABIArgGenerator::NonArgReturnReg1 = { (Registers::Code)0 };
const Register ABIArgGenerator::NonArg_VolatileReg = { (Registers::Code)0 };
const Register ABIArgGenerator::NonReturn_VolatileReg0 = { (Registers::Code)0 };
const Register ABIArgGenerator::NonReturn_VolatileReg1 = { (Registers::Code)0 };
