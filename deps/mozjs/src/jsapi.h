...
JS_PUBLIC_API(bool)
AddValueRootOLD(JSContext *cx, JS::Value *vp);

JS_PUBLIC_API(bool)
AddScriptRootOLD(JSContext *cx, JSScript **vp);
...
extern JS_PUBLIC_API(void)
RemoveValueRootOLD(JSContext *cx, JS::Value *vp);
...
extern JS_PUBLIC_API(bool)
JS_CompileUCScriptJX(JSContext *cx, JS::HandleObject obj,
                     const jschar *chars,
                   size_t length, const char *filename, int line_no,
                   bool for_asm_js, JS::MutableHandleScript script);
...
extern JS_PUBLIC_API(bool)
JS_CallFunctionValueJX(JSContext *cx, JS::Value& obj, JS::Value& fval, const JS::HandleValueArray& args,
                     JS::MutableHandleValue rval);
...
JS_GetTwoByteString(JSContext *cx, JSString *str, size_t &plength);
...
// Customized for JXcore (We need the exact amount of bytes stored)
JS_PUBLIC_API(char *)
JS_EncodeStringToUTF8AndLength(JSContext *cx, JS::HandleString str, size_t &length);
