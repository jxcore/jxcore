...
class JSObject : public js::ObjectImpl
{
  ...
  public:
    ...
    bool getHasExternalData() const{ return type_->hasData_ && this->extData_ != 0; }
  ...
  public:
    ...
    inline const bool hasReservedSlot(uint32_t index) const {
	return (index < JSSLOT_FREE(getClass()));
    }
