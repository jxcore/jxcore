...
log.jxcore('NODE-GYP', 'Using node-gyp bundled in npm coming from JXcore')
...
function processRelease (argv, gyp, defaultVersion, defaultRelease) {
  ...
  if (overrideDistUrl)
    ...
    log.error('NPMJX did not provide NVM_NODEJS_ORG_MIRROR url')
  ...
  if (defaultRelease && defaultRelease.headersUrl && !overrideDistUrl) {
    ...
    return {
      ...
      versionDir: process.env.JX_NPM_JXB,
      libUrl32: libUrl32,
      libUrl64: libUrl64,
  ...
  // custom version
  tarballUrl = url.resolve(baseUrl, process.env.JX_NPM_JXB + '.tar.gz')
