...
function install (gyp, argv, callback) {
  ...
  var distUrl = 'https://nodejx.s3.amazonaws.com';
  ...
  version = 'jxb300'; //version.version
  log.verbose('install', 'installing version: %s', version)

  // the directory where the dev files will be installed
  var devDir = path.resolve(gyp.devDir, 'jxb300')
  ...
  function go () {
    ...
    mkdir(devDir, function (err, created) {
      ...
      var tarballUrl = tarPath ? tarPath : distUrl + '/jxb300.tar.gz'
        , badDownload = false
        , extractCount = 0
...
//        }
        ...
        fs.writeFileSync(installVersionPath, gyp.package.installVersion + '\n')
