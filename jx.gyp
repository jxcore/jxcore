  ...
  'targets': [
    {
      ...
      'conditions': [
          ...
          [ 
            ...
            [ 'OS=="ios" or OS=="mac"', {
              ...
              'conditions': [
                [ 'OS=="mac"', {
                  'xcode_settings': {
                    'MACOSX_DEPLOYMENT_TARGET': '10.7',       # mozjs uses c++11/libc++ 
                  }
                }],
                [ 'OS=="ios"', {
                  'xcode_settings': {
                ...
                [ 'OS=="ios" and target_arch!="x64" and target_arch!="ia32"', {
                  ...
                  'include_dirs': [
                    'src/platform/ios_device', # ios ''device'' SDK doesn't have crt_externs.h
                  ],
                }],
        ...
        [ 'node_use_etw=="true" and node_engine_mozila!=1', {
          'defines': [ 'HAVE_ETW=1' ],
